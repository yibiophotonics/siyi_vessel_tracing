...
for subject in range(21):
    ...
    # read Image and Mask
    config_trace['image_name'] = '../whole_image/original_data/images/global_trace_input/input/test/'+str(subject)+'_test.tif'
    config_trace['mask_name'] = '../whole_image/original_data/images/global_trace_input//mask/'+str(subject)+'_manual_main_branch.png'
    ...
    if use_list:
        dataframe = pd.read_excel('/whole_image/original_data/images/global_trace_input/input/summary.xlsx')
...
# config_trace['secondpoint_list'] = [[307,87],[317,69],[194,109],[192,122]]
    ...
    for i in range(len(collect)):
        nameid = str(collect[i]) # for single start point # str(vessel_no[i]) + '_' + str(sample[i]) # 
